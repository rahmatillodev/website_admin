        ...
        <section className="space-y-4">
          ...
          <Card className="border-none shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] rounded-2xl">
            <CardContent className="p-6 space-y-6">
              <div className="space-y-2">
                <label className="text-[14px] font-bold text-slate-700">Telegram Bot API Key</label>
                <div className="relative">
                  <Bot className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400" />
                  <Input 
                    type={showApiKey ? "text" : "password"} 
                    value={formData.telegram_bot_api_key}
                    onChange={(e) => handleInputChange('telegram_bot_api_key', e.target.value)}
